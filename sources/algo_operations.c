...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/08/01 19:49:57 by clira-ne          #+#    #+#             */
/*   Updated: 2024/08/01 19:55:22 by clira-ne         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_get_best_operation(t_stack **a_stack, t_stack **b_stack)
{
	...
	while (current_node)
	{
		...
		{
			ft_moviments(a_stack, b_stack, \
				current_node->target_position, current_node->position);
			return ;
		}
...
void	ft_moviments(t_stack **a_stack, t_stack **b_stack, \
			int target_position, int position)
{
	t_stack	*a_current;
	t_stack	*b_current;
	...
	while (b_current)
	{
		if (a_current->a_cost > 0 && b_current->b_cost > 0)
			...
			ft_reverse_rotate_rrr(a_stack, b_stack, \
				a_current->index, a_current->index);
